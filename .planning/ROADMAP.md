...
- [x] **Phase 2: Audited Field-Edit for Post-Creation Corrections** - Let Atendente/Gestor correct contact, device credential, and customer identity on an existing OS, fully audited, without touching immutable delivery/warranty dates (completed 2026-09-19)
...
- [x] 02-02-PLAN.md — Device-credential correction audited with metadata only, sentinel-proved, plus the EDIT-04 date-immutability regression

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 02-03-PLAN.md — New `update_customer` endpoint for customer name/CPF, its counter affordance and the cadastro audit indicator

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 02-04-PLAN.md — Composed full-suite run, frontend build, CI, and human verification of the three correction journeys
...
- [x] 03-02-PLAN.md — Systematic cost/margin payload audit across every PDV and trade-in surface, plus any serializer fix it forces (AUDIT-04)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-03-PLAN.md — Trade-in condition-checklist completion gate, its read/write path, and the React wiring that makes it satisfiable (AUDIT-03)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 03-04-PLAN.md — Used Device Warranty linked and checked at check-in: covered means a no-charge OS, expired means an ordinary charged OS (AUDIT-05)
