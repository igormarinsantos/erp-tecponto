...
- [ ] 03-03-PLAN.md — Trade-in condition-checklist completion gate, its read/write path, and the React wiring that makes it satisfiable (AUDIT-03)
...
| 3. Systematic Audit — PDV → Trade-in → Warranty → Caixa | 2/5 | In Progress|  |
