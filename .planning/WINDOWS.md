...
fixed_count: 3
total_count: 3
last_updated: 2026-09-19T03:42:15.612Z
---
...
[
  ...
  },
  {
    ...
    "resolved_at": "2026-09-18T13:48:44.077Z"
  },
  {
    "id": 3,
    "kind": "skipped-test",
    ...
    "file": "tecponto_app/tecponto/frontend/test_frontend_api.py",
    "line": null,
    "description": "update_customer test fixture creates its customer as the same attendant who later edits it, so no automated test reproduces the cross-operator scenario that caused the real 403 fixed in cacbb21 (Customer.on_update -> create_primary_contact touching a Contact the editing user does not own). Fix is verified by manual/one-off-container repro, documented in 02-04-SUMMARY.md, but there is no standing regression tripwire for it. Flagged non-blocking by gsd-verifier in 02-VERIFICATION.md.",
    "status": "fixed",
    "reason": "",
    "recorded_at": "2026-09-19T03:40:01.203Z",
    "resolved_at": "2026-09-19T03:42:15.612Z"
  }
]
````
