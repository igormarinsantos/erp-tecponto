...
SERVICE_ORDER_TRANSITIONS = (
	...
	(STATE_ENTRADA_CRIADA, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_ATTENDANT),
	(STATE_ENTRADA_CRIADA, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_MANAGER),
