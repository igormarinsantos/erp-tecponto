...
SERVICE_ORDER_TRANSITIONS = (
	(STATE_ENTRADA_CRIADA, STATE_EM_DIAGNOSTICO, STATE_EM_DIAGNOSTICO, ROLE_TECHNICIAN, 'doc.caminho != "Rápido"'),
	(STATE_ENTRADA_CRIADA, STATE_EM_DIAGNOSTICO, STATE_EM_DIAGNOSTICO, ROLE_MANAGER, 'doc.caminho != "Rápido"'),
	(STATE_ENTRADA_CRIADA, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_ATTENDANT, 'doc.caminho != "Rápido"'),
	(STATE_ENTRADA_CRIADA, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_MANAGER, 'doc.caminho != "Rápido"'),
	(STATE_ENTRADA_CRIADA, "Iniciar execução", STATE_EM_REPARO, ROLE_TECHNICIAN, 'doc.caminho == "Rápido"'),
	(STATE_ENTRADA_CRIADA, "Iniciar execução", STATE_EM_REPARO, ROLE_MANAGER, 'doc.caminho == "Rápido"'),
	...
	(STATE_EM_DIAGNOSTICO, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_ATTENDANT),
	(STATE_EM_DIAGNOSTICO, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_TECHNICIAN),
	(STATE_EM_DIAGNOSTICO, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_MANAGER),
	(STATE_DIAGNOSTICADO_AGUARDANDO_ORCAMENTO, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_ATTENDANT),
	(STATE_DIAGNOSTICADO_AGUARDANDO_ORCAMENTO, STATE_AGUARDANDO_APROVACAO, STATE_AGUARDANDO_APROVACAO, ROLE_TECHNICIAN),
	...
	(STATE_APROVADO, STATE_AGUARDANDO_PECA, STATE_AGUARDANDO_PECA, ROLE_ATTENDANT),
	...
	(STATE_APROVADO, STATE_EM_REPARO, STATE_EM_REPARO, ROLE_ATTENDANT),
	(STATE_EM_REPARO, STATE_TESTE_FINAL, STATE_TESTE_FINAL, ROLE_TECHNICIAN),
	(STATE_EM_REPARO, "Reorçar", STATE_AGUARDANDO_APROVACAO, ROLE_TECHNICIAN, "doc.path_conversion_reason"),
	(STATE_EM_REPARO, "Reorçar", STATE_AGUARDANDO_APROVACAO, ROLE_MANAGER, "doc.path_conversion_reason"),
